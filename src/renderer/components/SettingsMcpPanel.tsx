...
import { getMcpPluginNotice } from "../lib/mcp-view-strategy"
...
/** Settings MCP Tab：维护 global/project 来源的 mcp.json（不含插件层 CRUD） */
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-lg border border-gray-700/60 bg-gray-900/40 px-3 py-2.5 text-xs">
        <p className="font-medium text-gray-300">MCP 配置 · Cursor SDK 执行引擎</p>
