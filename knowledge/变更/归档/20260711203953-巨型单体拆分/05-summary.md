...
2026-07-11：消息桥接/工作流叶子知识文件中裸 `daemon.ts` 锚点已局部同步至批1 实际落点（[`20260711232323-批1知识锚点同步`](../进行中/20260711232323-批1知识锚点同步/)）。**T16 全量知识库同步仍为 deferred**，本备注不替代 T8～T16 批2～4 范围。
